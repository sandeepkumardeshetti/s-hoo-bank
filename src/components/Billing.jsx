   ...
   (
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
          ...
          >
            <img
            src={apple} className='w-[128px] h-[42px] object-contain mr-5 cursor-pointer' alt="apple_store"
            />
            <img
            src={google} className='w-[128px] h-[42px] object-contain  cursor-pointer' alt="apple_store"
            />
